    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="12" :lg="6">
        <el-card class="m-box-card" shadow="hover">
          <div class="m-icon">
            <svg-icon id="icon-tasks" style="color: #F56C6C; font-size:47px;"></svg-icon>
          </div>
          <div class="m-content">
            <p>待办事项</p>
      ...
      <el-col :xs="24" :sm="12" :lg="6">
        <el-card class="m-box-card" shadow="hover">
          <div class="m-icon">
            <svg-icon id="icon-email" style="color: #E6A23C; font-size:47px;"></svg-icon>
          </div>
          <div class="m-content">
            <p>系统消息</p>
      ...
      <el-col :xs="24" :sm="12" :lg="6">
        <el-card class="m-box-card" shadow="hover">
          <div class="m-icon">
            <svg-icon id="icon-file_code" style="color: #67C23A; font-size:47px;"></svg-icon>
          </div>
          <div class="m-content">
            <p>代码量</p>
      ...
      <el-col :xs="24" :sm="12" :lg="6">
        <el-card class="m-box-card" shadow="hover">
          <div class="m-icon">
            <svg-icon id="icon-weather" style="color: #409EFF; font-size:47px;"></svg-icon>
          </div>
          <div class="m-content">
            <p>天气</p>
            <p>{{ info.weather }}</p>
              ...
              <div style="height: 215px; margin: -20px;background-color: rgb(247, 151, 214);color:#ffffff;">
                <vue-scroll>
                  <div style="padding: 20px;">
                    ...
                    <p v-for="index in 20" :key="index">{{index}}. 123123</p>
                  </div>
                </vue-scroll>
              </div>
            </el-card>
      ...
      <el-col :sm="24" :lg="12">
        <el-card class="m-box-card" shadow="hover" style="height: 300px">
          ...
          <div class="m-task-box">
            ...
            <div class="m-task-pro">
              <el-progress :text-inside="true" :stroke-width="18" :percentage="60" color="rgba(142, 113, 199, 0.7)"></el-progress>
            </div>
          </div>
          <div class="m-task-box">
  ...
  data () {
    return {
      info: {
        ...
        code: parseFloat(7890).toLocaleString(),
        weather: '北京，-10℃，多云'
      },
      user: {
        name: '姚雨青',
        loginTime: '2018-11-05 12:00:00',
        loginIp: '192.168.1.1',
        lastTime: '2018-12-01 12:00:00',
        lastIp: '192.168.2.1'
      },
      chartData1: {
